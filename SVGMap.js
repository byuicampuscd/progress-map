var index = 15;
      var pics = [
         ...
         {fileName: 'badge3.png', x: 174, y: 133, dx:  0, dy:   0, scalePic:0.29, animateScale:2},
         {fileName: 'badge4.png', x: 209, y: 303, dx:  0, dy: -50, scalePic:0.29, animateScale:2},
         {fileName: 'badge5.png', x: 343, y: 226, dx:  0, dy:   0, scalePic:0.29, animateScale:2},
         {fileName: 'badge6.png', x: 256, y:  47, dx:  0, dy:  50, scalePic:0.29, animateScale:2},
         {fileName: 'badge7.png', x: 357, y: 124, dx:  0, dy:   0, scalePic:0.29, animateScale:2},
         {fileName: 'badge8.png', x: 437, y:  47, dx:  0, dy:  50, scalePic:0.29, animateScale:2},
         {fileName: 'badge9.png', x: 545, y:  69, dx:  0, dy:  30, scalePic:0.29, animateScale:2},
         {fileName:'badge10.png', x: 450, y: 171, dx:  0, dy:   0, scalePic:0.29, animateScale:2},
         {fileName:'badge11.png', x: 483, y: 282, dx:  0, dy: -30, scalePic:0.29, animateScale:2},
         {fileName:'badge12.png', x: 584, y: 272, dx:  0, dy: -20, scalePic:0.29, animateScale:2},
         {fileName:'badge13.png', x: 624, y: 169, dx:  0, dy:   0, scalePic:0.29, animateScale:2},
         {fileName:'badge14.png', x: 715, y: 265, dx:  0, dy: -15, scalePic:0.29, animateScale:2},
         {fileName:'badge15.png', x: 762, y:  77, dx:  0, dy:  20, scalePic:0.29, animateScale:2},
         {fileName:'badge16.png', x: 884, y:  86, dx:  0, dy:  10, scalePic:0.29, animateScale:2},
         {fileName:'badge17.png', x: 838, y: 210, dx:  0, dy:   0, scalePic:0.29, animateScale:2},
         {fileName:'badge18.png', x: 938, y: 292, dx:  0, dy: -40, scalePic:0.29, animateScale:2},
         {fileName:'badge19.png', x: 970, y: 147, dx:  0, dy:   0, scalePic:0.29, animateScale:2},
      ...
      function mapStartUp(){
         var draw = SVG('map').size(1104, 350)
         
         //setup event
         SVG.registerEvent('jam:goBack');
      ...
      function fillLine(percentComplete){
         percentComplete /= 100;
         var steps  = 100;
         var length = 6000 * percentComplete;
         var timeChunk = length/steps
      ...
      function changeIt(numIn){
         ...
         var path = document.getElementById("pathLine")
         var percentComplete =  numIn / 100;
         
         //update the line
         path.style.strokeDashoffset = pathLenth * (1 - percentComplete);
         
         //update the pictures
         var picsToShow = Math.floor(pics.length * percentComplete);
         for(var i = 0; i < pics.length; ++i){
      ...
      function makeBadges(draw, picIn, counter){
         var image = draw.image(picLocation + picIn.fileName).loaded(function(loader) {
         ...
         var groupMe = draw.group().center(picIn.x, picIn.y).add(image);
         groupMe.attr("id", 'pic' + counter);
         groupMe.hide();
         
         groupMe.on('jam:goBack', function(){
               //debugger;
